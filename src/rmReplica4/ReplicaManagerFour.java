...
public class ReplicaManagerFour {
	...
	String nameOfReplica = "RM4";
	private ManagerHelperFour managerHelperOne = new ManagerHelperFour();
	...
	public static void main(String args[]) throws Exception {
		ReplicaManagerFour remoteManagerFour = new ReplicaManagerFour();

		//	String reply = remoteManagerFour.managerHelperOne.forwardToReplica("deposit QCC1000 500",7654);

		//System.out.println(reply);

		Thread t1 = new Thread(() -> {
			try {
				remoteManagerFour.takeRequestFromSequencer();
			} catch (Exception e1) {
				e1.printStackTrace();
			}
		});
	...
	public void sendReplyToFE(String requestID, String replyFromReplicaString) throws SocketException, IOException {
		...
		sentence = requestID + " " + "RM4"+" "+Long.toString(startTime) + " " + replyFromReplicaString;
