...
public class ReplicaManagerTwo {
	...
	String nameOfReplica = "RM2";
	private ManagerHelperTwo managerHelperOne = new ManagerHelperTwo();
	...
	public static void main(String args[]) throws Exception {
		ReplicaManagerTwo remoteManagerTwo = new ReplicaManagerTwo();

		//	String reply = remoteManagerTwo.managerHelperOne.forwardToReplica("deposit QCC1000 500",7654);

		//System.out.println(reply);

		Thread t1 = new Thread(() -> {
			try {
				remoteManagerTwo.takeRequestFromSequencer();
			} catch (Exception e1) {
				e1.printStackTrace();
			}
		});
	...
	public void sendReplyToFE(String requestID, String replyFromReplicaString) throws SocketException, IOException {
		...
		sentence = requestID + " " + "RM2"+" "+ Long.toString(startTime) + " " + replyFromReplicaString;
